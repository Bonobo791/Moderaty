...
This directory vendors the selected skills, manifests, and harness hooks from the upstream Superpowers agent skills framework.

- Upstream: https://github.com/obra/superpowers
- Release: `v6.3.0`
- Release commit: `b36e0829c6d0140e93cfef2ca599b1b07d4a7797`
...
Documentation trailing whitespace in the vendored README and release notes is normalized for repository diff checks.
