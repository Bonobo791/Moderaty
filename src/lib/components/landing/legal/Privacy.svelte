...
<p><strong>3.4</strong> If you are a comment author and want to exercise rights over a comment, please contact the channel owner (the controller). If you contact us directly, we will forward your request to the channel owner where possible, within 5 business days. Because we never store author identifiers, we cannot identify a comment's author or link stored comment text back to them.</p>
