...
<!--
	Inline icon set. Path data from Phosphor Icons (https://phosphoricons.com),
	MIT licensed, regular weight — inlined so the app ships zero icon
	dependencies and zero external requests.
-->
