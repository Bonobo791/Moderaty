...
<h1>Help</h1>
<p class="page-sub">How Moderaty moderates, and what you can take back.</p>
...
<div class="card">
	<h2>The audit log</h2>
	<p>
		Every moderation action, automatic or manual, is recorded in the channel's audit log
		(newest first, with the reason and who decided it — rule, AI, or you).
	</p>
</div>
...
<div class="card">
	...
	<p>
		Beyond moderation, Moderaty can group your comments into a digest of what viewers keep
		telling you: recurring questions, substantive criticism, corrections, and requests. A theme
		only shows up once several viewers raise it — one-off remarks are counted but never listed.
	</p>
	<p>
		...
		replies on your behalf. Turn it on per channel from the channel's <strong>Feedback</strong>
		tab, where you can also pick the categories, the cadence, and the evidence threshold.
	</p>
</div>
		...
		<tbody>
			...
			<tr>
				...
				<td data-label="Reversible?">
					Partly — Undo restores the comment, but author bans cannot be lifted, reversed, or
					undone: YouTube provides no way to un-ban an author through its API.
				</td>
			</tr>
			<tr>
				<td data-label="Action"><span class="badge danger">delete</span></td>
				<td data-label="Reversible?">
					No — deleted comments cannot be restored, reversed, or undone. Deletion is
					permanent.
				</td>
			</tr>
		</tbody>
