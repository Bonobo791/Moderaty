...
export const FAQ_ENTRIES: FaqEntry[] = [
	...
	},
	{
		...
		a: 'Yes. Moderaty is built in Brazil around the LGPD: comment text is kept with the verdict record so your review queue works, but comment author identities are never stored. No author profiling, no model training on comment data. The Privacy Policy and DPA, linked in the footer, spell it out.'
	}
];
